var FaceTecStrings = {
  ...
  "FaceTec_camera_feed_issue_action_firefox_permissions_error": "ΠΡΟΣΠΑΘΗΣΤΕ ΞΑΝΑ",

  "FaceTec_camera_permission_header": "Ενεργοποίηση κάμερας",
  "FaceTec_camera_permission_message": "Παρακαλούμε βεβαιωθείτε ότι τα Δικαιώματα Κάμερας του Λειτουργικού Συστήματος και του Προγράμματος Περιήγησης είναι ενεργοποιημένα. <a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>>Μάθετε περισσότερα εδ</a>.",
