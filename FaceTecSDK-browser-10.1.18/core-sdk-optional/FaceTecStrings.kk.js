var FaceTecStrings = {
  ...
  "FaceTec_camera_feed_issue_action_firefox_permissions_error": "ҚАЙТАДАН БАЙҚАП КӨРІҢІЗ",

  "FaceTec_camera_permission_header": "Камераны қосыңыз",
  "FaceTec_camera_permission_message": "Амалдық жүйе мен веб-камера рұқсаттарының қосылғанына көз жеткізіңіз. <a href='https://livenesscheckhelp.com/' target='_blank' style='text-decoration:underline; font:inherit; pointer-events:all;'>Толығырақ мына жерден біліңіз.</a>.",
