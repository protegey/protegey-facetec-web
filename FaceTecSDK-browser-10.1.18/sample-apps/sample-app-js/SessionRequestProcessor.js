...
var SessionRequestProcessor = /** @class */ (function () {
    function SessionRequestProcessor() {
        var _this = this;
        ...
        this.onSessionRequest = function (sessionRequestBlob, sessionRequestCallback) {
            ...
            SampleAppNetworkingRequest.send(_this, sessionRequestBlob, sessionRequestCallback);
        };
        // When the request blob has been received, send it back to the FaceTecSDK for continued processing
        this.onResponseBlobReceived = function (responseBlob, sessionRequestCallback) {
        ...
        this.onUploadProgress = function (progress, sessionRequestCallback) {
        ...
        this.onCatastrophicNetworkError = function (sessionRequestCallback) {
        ...
        this.onFaceTecExit = function (faceTecSessionResult) {
            SampleAppController.demonstrateHandlingFaceTecExit(faceTecSessionResult);
        };
    }
    return SessionRequestProcessor;
}());
