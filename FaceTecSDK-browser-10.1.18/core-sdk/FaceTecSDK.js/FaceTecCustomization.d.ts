...
export interface FaceTecCancelButtonCustomization {
    ...
    hideForCameraPermissions: boolean;
}
...
export interface FaceTecIDScanCustomization {
   ...
   */
     ...
     * Default is white.
     */
    idFeedbackScreenBackgroundColors: string;
    /**
    ...
    /**
     * Image displayed on the ID Scan Feedback Screen.
     ...
     * Default is false (shown).
     */
    disableIDFeedbackScreen: boolean;
    /**
     ...
     * Default is 2.
     */
    additionalReviewScreenAnimationDisplayTime: number;
    /**
     ...
     * Default is 2.
     */
    idFeedbackScreenAnimationDisplayTime: number;
}
...
export declare class FaceTecCustomization {
    ...
    */
    ...
    [key: string]: {
        key: string;
    }[] | boolean | FaceTecVocalGuidanceCustomization | FaceTecSecurityWatermarkCustomization | FaceTecEnterFullScreenCustomization | FaceTecOCRConfirmationCustomization | FaceTecIDScanCustomization | FaceTecOvalCustomization | FaceTecFeedbackBarCustomization | FaceTecFrameCustomization | FaceTecExitAnimationCustomization | FaceTecCancelButtonCustomization | FaceTecInitialLoadingAnimationCustomization | FaceTecGuidanceCustomization | FaceTecOverlayCustomization | FaceTecResultScreenCustomization | FaceTecOrientationScreenCustomization | string;
}
/**
 * @public
...
export declare class FaceTecCancelButtonCustomization {
     ...
     * Default is false (shown and enabled).
     */
    hideForCameraPermissions: boolean;
...
export declare class FaceTecIDScanCustomization {
    ...
    */
    ...
    constructor();
    [key: string]: string | number | boolean | SVGElement | null;
}
